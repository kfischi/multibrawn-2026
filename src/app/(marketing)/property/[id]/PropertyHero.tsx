    ...
    <>
      ...
      {showGallery && (
        <div className="fixed inset-0 z-50 bg-black">
          ...
          <button
            onClick={prevImage}
            className="absolute left-6 top-1/2 -translate-y-1/2 z-10 p-4 bg-white/10 backdrop-blur-md rounded-full hover:bg-white/20 transition-all"
          >
          ...
          <button
            onClick={nextImage}
            className="absolute right-6 top-1/2 -translate-y-1/2 z-10 p-4 bg-white/10 backdrop-blur-md rounded-full hover:bg-white/20 transition-all"
          >
